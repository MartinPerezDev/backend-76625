...
function main() {
  ...
  console.log(productManager.addProduct({ title: "Mouse GTX", description: "Mouse inalambrico" }));
  console.log(productManager.deleteProductById(2));
  console.log(productManager.addProduct({ title: "Monitor Asus", description: "Monitor 144Hz" }));
